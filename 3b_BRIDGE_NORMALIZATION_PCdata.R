...
cat("\n\n\n\n###############################################################################################\n",
    ...
    # write.csv(filepaths_df, "1_filepaths_singleplate.csv") #a copy of object created at the time of submission was kept for reference. Can be shared upon request. 
...
# all_plates_manifest_df <- read.func.csv(filepaths_df, 4, olink=FALSE)


# cat("\n\n\n\n###############################################################################################\n",
#             "3. PREP THE PLATE DATA (NPX): OLD SOFTWARE\n",
#             "###############################################################################################\n\n\n")
