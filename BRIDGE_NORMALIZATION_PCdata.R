...
cat("\n\n\n\n###############################################################################################\n",
            "12. QC OF PLATES A TO C BRIDGING \n",
            "###############################################################################################\n\n\n")
...
# PCA plot
pca_plot_AvsC <- olink_pca_plot(df = AvsC_bridged_data, color_g = "Type", byPanel= TRUE)

str(pca_plot_AvsC)


# cat("\n\n\n\n###############################################################################################\n",
#             "13. QC OF PLATES B TO C BRIDGING \n",
#             "###############################################################################################\n\n\n")
...
# # PCA plot
# pca_plot_BvsC <-<- olink_pca_plot(df = BvsC_bridged_data, color_g = "Type", byPanel= TRUE)
